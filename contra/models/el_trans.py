...
class Al_Trans(nn.Module):
    def __init__(self, vocab_size=5000, emb_dim=300, hid_dim=128, max_length=512, maps=None, article_details=None, charge_details=None) -> None:
        ...
        self.transformer_char_dec = Transformer(
                ...
                # Keep both decoder self-attention stages to match K-LJP Figure 3.
    ...
    def forward(self, data):
        ...
        enc_src = self.enc(fact_text, valid_token_mask)
        if ADD_CNN:
            enc_src = self.CNN(enc_src, padding_mask=padding_mask)
